...
export const Hero: React.FC<HeroProps> = ({ 
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute bottom-[28%] right-[8%] hidden xl:block z-20 animate-float pointer-events-none" style={{ animationDelay: '1.5s' }}>
         <GlassCard 
...
const GlassCard = ({ icon, label, value, trend, rotation = "-5deg" }: { icon: React.ReactNode, label: string, value: string, trend: string, rotation?: string }) => (
  <div 
    className="glass-card p-4 rounded-2xl flex items-center gap-4 w-60 transition-transform duration-500 hover:rotate-0 hover:scale-105 pointer-events-auto shadow-2xl" 
